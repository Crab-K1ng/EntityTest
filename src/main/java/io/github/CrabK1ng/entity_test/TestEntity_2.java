...
public class TestEntity_2 extends Entity {
    public static final String ENTITY_TYPE_ID = "test_entity:test_entity_2";
    ...
    public void update(Zone zone, double deltaTime) {
        ...
        if (closestPlayerEntity != null && this.timeSinceActivated < 0.0F && this.model != null) {
            //this.model.setCurrentAnimation(this, "animation.entity-test.idle");
